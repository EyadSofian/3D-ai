...
// الفم بيبدأ يتشكّل قبل الصوت وبيسيب الشكل بعده — دي الـ coarticulation.
// القيم الواطية بتدّي نطق "مقطّع"؛ العالية بتمسح الفرق بين الحروف.
const ATTACK = 0.065;
const RELEASE = 0.105;
...
export class LipSync {
  ...
  sample(t, env = 1) {
    ...
    // الأرضية بتسيب السواكن (طاقتها واطية) باينة، بس مش عالية أوي
    // عشان يفضل فيه فرق واضح بين الصوت العالي والواطي.
    const gain = 0.42 + 0.58 * Math.min(1, env);
    jaw *= gain;
